        ...
        <motion.article initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.8 }}>
          <header style={{ marginBottom: isLargeMobile ? '32px' : '48px' }}>
            ...
            <p style={{ fontSize: isLargeMobile ? '1rem' : '1.25rem', color: '#64748b', lineHeight: '1.6' }}>
              Mengungkap keunggulan mutlak teknologi cetak offset dalam menghasilkan kualitas premium dengan efisiensi biaya produksi maksimal.
            </p>
          </header>
          ...
          <section style={{ fontSize: isLargeMobile ? '1rem' : '1.125rem', lineHeight: '1.8', color: '#334155' }}>
            ...
            <p style={{ marginBottom: '20px' }}>
              Meskipun digital printing hadir untuk kebutuhan instan, teknologi ini memiliki banyak batasan yang tidak dimiliki oleh mesin offset profesional:
            </p>
            ...
            <ul style={{ paddingLeft: '20px', marginBottom: '24px' }}>
              ...
              <li style={{ marginBottom: '12px' }}><strong>Efisiensi Harga Skala Besar:</strong> Inilah alasan utama kenapa <strong>percetakan offset</strong> selalu dipilih untuk <strong>cetak packaging makanan</strong> atau <strong>kotak rokok</strong>. Semakin banyak Anda mencetak, harga per pcs akan turun drastis—bahkan bisa mencapai 1/10 dari harga digital printing.</li>
