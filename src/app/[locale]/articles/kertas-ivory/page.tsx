        ...
        <motion.article initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.8 }}>
          ...
          <section style={{ fontSize: isLargeMobile ? '1rem' : '1.125rem', lineHeight: '1.8', color: '#334155' }}>
            ...
            <ul style={{ paddingLeft: '20px', marginBottom: '24px' }}>
              ...
              <li style={{ marginBottom: '12px' }}><strong>Sisi Belakang (Uncoated/Doff):</strong> Tidak memiliki lapisan kimia tambahan, sehingga teksturnya sedikit lebih kasar dan doff. Sisi ini memiliki daya serap tinta yang lebih tinggi namun saturasi warna yang dihasilkan lebih rendah dibandingkan sisi depan.</li>
            </ul>
            <p style={{ marginBottom: '24px' }}>
            ...
            <ul style={{ paddingLeft: '20px', marginBottom: '24px' }}>
              <li style={{ marginBottom: '8px' }}><strong>Laminasi (Doff/Glossy):</strong> Memberikan perlindungan ekstra terhadap air dan gesekan.</li>
              <li style={{ marginBottom: '8px' }}><strong>UV Spot:</strong> Sangat efektif pada ivory karena kontras antara area glossy spot dan permukaan kertas yang halus sangat kentara.</li>
              ...
              <li style={{ marginBottom: '8px' }}><strong>Emboss/Deboss:</strong> Karena seratnya yang panjang dan kuat, ivory tidak mudah retak (cracking) saat diberi tekanan untuk efek timbul.</li>
            </ul>
            ...
            <div style={{ backgroundColor: '#f1f5f9', padding: isLargeMobile ? '24px' : '32px', borderRadius: '24px', marginTop: '48px', marginBottom: '40px' }}>
              ...
              <p style={{ marginBottom: '12px' }}><strong>Q: Apakah kertas ivory bisa dicetak offset?</strong><br />A: Ya, ini adalah metode terbaik. Ivory sangat ideal untuk mesin offset Heidelberg atau Komori.</p>
              <p><strong>Q: Bisakah ivory digunakan untuk packaging produk beku?</strong><br />A: Bisa, namun wajib menggunakan varian PE-Coated untuk mencegah kertas hancur akibat kondensasi.</p>
            </div>
          </section>
        </motion.article>
